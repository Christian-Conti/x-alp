...
class SOC_ctrl(BasePeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/soc_ctrl/data/soc_ctrl.hjson
    """

    _name = "soc_ctrl"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/soc_ctrl/data/soc_ctrl.hjson"
...
class DMA(BasePeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/dma/data/dma.hjson
    ...
    _name = "dma"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/dma/data/dma.hjson"
...
class Power_manager(BasePeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/power_manager/data/power_manager.hjson
    """

    _name = "power_manager"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/power_manager/data/power_manager.hjson"
...
class Fast_intr_ctrl(BasePeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/fast_intr_ctrl/data/fast_intr_ctrl.hjson
    """

    _name = "fast_intr_ctrl"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/fast_intr_ctrl/data/fast_intr_ctrl.hjson"
...
class UART(BasePeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/uart/data/uart.hjson
    """

    _name = "uart"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/uart/data/uart.hjson"
