...
class RV_plic(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/rv_plic/data/rv_plic.hjson
    
    """

    _name = "rv_plic"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/rv_plic/data/rv_plic.hjson"
...
class SPI_host(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan_spi_host/data/spi_host.hjson
    """

    _name = "spi_host"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan_spi_host/data/spi_host.hjson"
...
class GPIO(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/pulp_platform_gpio/gpio_regs.hjson
    """

    _name = "gpio"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/pulp_platform_gpio/gpio_regs.hjson"
...
class I2C(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/i2c/data/i2c.hjson
    """

    _name = "i2c"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/i2c/data/i2c.hjson"
...
class RV_timer(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/rv_timer/data/rv_timer.hjson
    """

    _name = "rv_timer"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/vendor/lowrisc_opentitan/hw/ip/rv_timer/data/rv_timer.hjson"
...
class PDM2PCM(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/pdm2pcm/data/pdm2pcm.hjson
    """

    _name = "pdm2pcm"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/pdm2pcm/data/pdm2pcm.hjson"
...
class I2S(UserPeripheral, DataConfiguration):
    ...
    Default configuration file: ./hw/vendor/eslepfl_xheep/hw/ip/i2s/data/i2s.hjson
    """

    _name = "i2s"
    _config_path = "./hw/vendor/eslepfl_xheep/hw/ip/i2s/data/i2s.hjson"
