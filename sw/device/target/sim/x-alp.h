...
// Given this range, by dividing by 100 it always remains integer and below
// 32-bits. This saves us the need of performing 64-bit divisions to compute
// NCO.
#define UART_NCO                                                                                                       \
  ((uint32_t)(((uint32_t)((uint32_t)(UART_BAUDRATE / 100)) << 20) / ((uint32_t)(REFERENCE_CLOCK_Hz / 100))))
#define TARGET_SIM 1
