...
| soc_ctrl.[`BOOT_SELECT`](#boot_select)                 | 0x8      |        4 | Boot Select Value - Used to decide whether to boot from JTAG or FLASH                                                           |
...
```wavejson
{"reg": [{"name": "BOOT_SELECT", "bits": 1, "attr": ["ro"], "rotate": -90}, {"bits": 31}], "config": {"lanes": 1, "fontsize": 10, "vspace": 130}}
```

|  Bits  |  Type  |  Reset  | Name        | Description     |
|:------:|:------:|:-------:|:------------|:----------------|
|  31:1  |        |         |             | Reserved        |
|   0    |   ro   |    x    | BOOT_SELECT | Boot Select Reg |
