...
#define UART_CTRL_RXBLVL_FIELD ((bitfield_field32_t){.mask = UART_CTRL_RXBLVL_MASK, .index = UART_CTRL_RXBLVL_OFFSET})
...
#define UART_CTRL_NCO_FIELD ((bitfield_field32_t){.mask = UART_CTRL_NCO_MASK, .index = UART_CTRL_NCO_OFFSET})
...
#define UART_RDATA_RDATA_FIELD ((bitfield_field32_t){.mask = UART_RDATA_RDATA_MASK, .index = UART_RDATA_RDATA_OFFSET})

// UART write data
#define UART_WDATA_REG_OFFSET 0x18
#define UART_WDATA_WDATA_MASK 0xff
#define UART_WDATA_WDATA_OFFSET 0
#define UART_WDATA_WDATA_FIELD ((bitfield_field32_t){.mask = UART_WDATA_WDATA_MASK, .index = UART_WDATA_WDATA_OFFSET})
...
#define UART_VAL_RX_FIELD ((bitfield_field32_t){.mask = UART_VAL_RX_MASK, .index = UART_VAL_RX_OFFSET})
