...
int jtag_tick(int port, unsigned char *jtag_TCK, unsigned char *jtag_TMS, unsigned char *jtag_TDI,
...

{
  ...
  if (VERBOSE)
    fprintf(stderr, "Tick with: TCK=%hhd TMS=%hhd TDI=%hhd TRSTn=%hhd --> TDO=%hhd\n", *jtag_TCK, *jtag_TMS, *jtag_TDI,
            *jtag_TRSTn, jtag_TDO);
